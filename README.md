...
|----------------|------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| **Streamlines** | <div align="center"><img src="Plots/Figure_Potential.png" width="100%"></div>           | **(A)** can be generated with the `'grid'` keyword and **(B)** and **(C)** can be generated with `'streamlines'` |
| **Velocity**    | <div align="center"><img src="Plots/Figure_Velocity.png" width="100%"></div>            | **(A)** can be generated with the `'grid'` keyword and **(B)** and **(C)** can be generated with `'velocity'`  |
| **Pressure**    | <div align="center"><img src="Plots/PressurePlot.png" width="50%"></div>                | The pressure contour plot can be generated by `'pressure'`                  |
